...
var budgetController = (function () {
    ...
    return {
      ...
      getPercentage: function () {
        // we use map method because we also want to return something and store it. This is the differnce between map and foreach
        var allPercentage = data.allItems.exp.map(function (cur) {
          return cur.getPercentage();
        });
        // outside the function because up is in the loop
  ...
  var UIController = (function () {
    ...
    return {
      ...
      addListItem: function (obj, type) {
        ...
        // we pass the second parameter type because it needs to be format number function
      ...
      displayPercentages: function (percentages) {
        // we use querySelector all because we dont know how many percentage we have
        var fields = document.querySelectorAll(DOMstrings.expensesPercLabel);
        // it return a list and is called node list
        // node list does  have again foreach property
